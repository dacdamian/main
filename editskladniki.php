  ...
  <head>
    ...
    <body>
        ...
        <?php
			...
			if(!empty($zdjecie)) {
            $update = "UPDATE skladniki SET nazwa='$nazwa', stan='$stan', zdjecie='$zdjecie', data_utworzenia=NOW() WHERE id='$id'";
                mysql_query($update);
                ...
                echo '<hr /><h3><center>Rekord zaktualizowany.</center></h3>';
					...
					$update1 = "UPDATE skladniki SET nazwa='$nazwa', stan='$stan', data_utworzenia=NOW() WHERE id='$id'";
					mysql_query($update1);
