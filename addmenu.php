  ...
  <head>
    ...
    <body>
        ...
        <?php
			...
			if(!empty($zdjecie)) {
            $insert = "INSERT INTO menu SET nazwa='$nazwa', zdjecie='$zdjecie', data_utworzenia=NOW(), cena='$cena', skladniki='$separator'";
                mysql_query($insert);
                ...
                echo '<hr /><h3><center>Rekord zaktualizowany.</center></h3>';
					...
					$insert1 = "INSERT INTO menu SET nazwa='$nazwa', data_utworzenia=NOW(), cena='$cena', skladniki='$separator'";
					mysql_query($insert1);
